...
When you receive structured JSON from the hook script, extract fields directly — no boundary detection needed:
...
### When input is structured JSON (from the hook script):
