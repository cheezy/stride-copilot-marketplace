...
| [`stride-copilot-security-review`](plugins/stride-copilot-security-review) | 0.4.0 | AI-powered security review for code changes via the `security-review-essentials` skill: multi-language semantic vulnerability detection with SARIF output and CI severity gating. |
