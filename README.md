...
|--------|---------|-------------|
| [`stride-copilot`](plugins/stride-copilot) | 2.27.0 | Task lifecycle skills and custom agents for Stride kanban: claiming, completing, and creating tasks and goals for AI agents in GitHub Copilot CLI. |
...
| [`stride-copilot-security-review`](plugins/stride-copilot-security-review) | 0.3.0 | AI-powered security review for code changes via the `security-review-essentials` skill: multi-language semantic vulnerability detection with SARIF output and CI severity gating. |
