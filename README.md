...
| [`stride-copilot-ideation`](plugins/stride-copilot-ideation) | 0.2.1 | Turn an idea into shipped Stride tasks from GitHub Copilot CLI: an interactive ideation session that produces a committed requirements doc, plus a stridify step that decomposes it into a Stride batch and posts it to the API. |
